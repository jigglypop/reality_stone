# 3장. 리만 메트릭 추출: 94% 압축의 비밀 (Riemannian Metric Extraction)
...
여기서 $G$는 $k \times k$ 크기의 학습 가능한 행렬로, 입력 기저 개념과 출력 기저 개념 사이의 **측지선 거리(Geodesic Distances)** 를 인코딩합니다. 

$G$는 대각 행렬일 필요가 없으며, 비대각 성분은 개념 간의 '기하학적 얽힘(Entanglement)'을 나타냅니다.
