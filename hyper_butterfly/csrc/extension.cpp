...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("mobius_add_cuda", &manifolds::mobius_add_cuda, "Möbius addition (CUDA)");
    m.def("mobius_scalar_cuda", &manifolds::mobius_scalar_cuda, "Möbius scalar multiplication (CUDA)");
#ifdef WITH_CUDA
