...
using hyper_butterfly::butterfly_layer_cuda;
using hyper_butterfly::butterfly_layer_backward_cuda;
using hyper_butterfly::utils::next_pow2;
using hyper_butterfly::utils::EPS;
