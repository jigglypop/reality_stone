// hyper_butterfly/csrc/transforms/butterfly/backward.cu
#include <torch/extension.h>
#include <cuda.h>
#include <cuda_runtime.h>
#include "backward_butterfly.h"
...
namespace hyper_butterfly
{
    namespace ops
    {
        namespace butterfly
        {
            ...
            // CUDA 버터플라이 레이어 역전파 구현
            vector<Tensor> butterfly_backward_cuda(
                Tensor grad_out,
                Tensor input,
                Tensor params,
                int layer_idx)
            {
                ...
                auto grad_params = zeros_like(params);
                ...
                AT_DISPATCH_FLOATING_TYPES(
                    ...
                    ([&]
                     { butterfly_backward_kernel<scalar_t><<<blocks, threads>>>(
...
vector<Tensor> butterfly_backward_cuda_export(
    ...
    int layer_idx)
{
    return hyper_butterfly::ops::butterfly::butterfly_backward_cuda(
        grad_out, input, params, layer_idx);
}