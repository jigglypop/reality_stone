"""CLI for BA-TR26 conditional 3x3 affine-content transfer."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.stage.startswith("generate-"):
        ...
        if args.input is None:
            parser.error("--input is required for affine-content analysis")
        result = analyze_3x3_unlabeled_content_artifact(args.input, stage=args.stage)
