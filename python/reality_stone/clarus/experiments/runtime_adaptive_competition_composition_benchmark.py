"""CLI for BA-TR17 adaptive competition composition."""
...
from .runtime_adaptive_competition_composition import (
    CALIBRATION_SEEDS,
    DEVELOPMENT_SEEDS,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.stage.startswith("generate-"):
        ...
        if args.input is None:
            parser.error("--input is required for adaptive analysis")
        result = analyze_adaptive_artifact(args.input, stage=args.stage)
