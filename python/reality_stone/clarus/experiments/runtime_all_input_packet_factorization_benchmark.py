"""CLI for BA-TR21 all-input packet factorization."""
...
from .runtime_all_input_packet_factorization import (
    CALIBRATION_SEEDS,
    DEVELOPMENT_SEEDS,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.stage.startswith("generate-"):
        ...
        if args.input is None:
            parser.error("--input is required for all-input analysis")
        result = analyze_all_input_artifact(args.input, stage=args.stage)
