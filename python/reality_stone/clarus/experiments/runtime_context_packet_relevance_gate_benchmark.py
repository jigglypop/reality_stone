"""CLI for BA-TR23 context packet relevance gate."""
...
from .runtime_context_packet_relevance_gate import (
    CALIBRATION_SEEDS,
    DEVELOPMENT_SEEDS,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.stage.startswith("generate-"):
        ...
        if args.input is None:
            parser.error("--input is required for context gate analysis")
        result = analyze_context_gate_artifact(args.input, stage=args.stage)
