"""CLI for BA-TR15 fresh inputs and attenuation-compensated binding."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.stage.startswith("generate-"):
        ...
        if args.input is None:
            parser.error("--input is required for calibration/development analysis")
        result = analyze_fresh_input_artifact(args.input, stage=args.stage)
