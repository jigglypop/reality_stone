"""CLI for BA-TR18 source-factorized competition."""
...
from .runtime_factorized_competition_composition import (
    CALIBRATION_SEEDS,
    DEVELOPMENT_SEEDS,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.stage.startswith("generate-"):
        ...
        if args.input is None:
            parser.error("--input is required for factorized analysis")
        result = analyze_factorized_artifact(args.input, stage=args.stage)
