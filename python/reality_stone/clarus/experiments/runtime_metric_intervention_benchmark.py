"""CLI for the frozen G1 weight--metric--dynamics intervention benchmark."""
...
from .runtime_metric_intervention import (
    CONFIRMATION_SEEDS,
    DEVELOPMENT_SEEDS,
    run_g1_seed_range,
    summarize_g1,
...
_FREEZE_FILES = (
    "reality_stone/python/reality_stone/clarus/experiments/runtime_metric_intervention.py",
    "reality_stone/python/reality_stone/clarus/experiments/runtime_metric_intervention_benchmark.py",
    "tests/test_runtime_metric_intervention.py",
    "_workspace/ce/brainruntime-weight-metric-dynamics-intervention-20260819/00-contract.md",
    "_workspace/ce/brainruntime-weight-metric-dynamics-intervention-20260819/11-math.md",
    "_workspace/ce/brainruntime-weight-metric-dynamics-intervention-20260819/20-audit.md",
)
...
def _verify_confirmation_manifest(path: Path) -> dict[str, Any]:
    ...
    if manifest.get("development_route_verdict") != "GO":
        raise RuntimeError("confirmation is sealed because development did not GO")
