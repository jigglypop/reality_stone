"""CLI for BA-TR28 rotating full-degree-two content transfer."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.stage.startswith("generate-"):
        ...
        if args.input is None:
            parser.error("--input is required for rotating low-degree analysis")
        result = analyze_rotating_low_degree_artifact(args.input, stage=args.stage)
